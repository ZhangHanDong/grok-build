...
- [第 3 章：Actor 化的会话引擎](ch03-session-actor.md)
- [第 4 章：Agentic 循环](ch04-agentic-loop.md)
- [第 5 章：上下文管理与压缩](ch05-compaction.md)
- [第 6 章：会话持久化](ch06-persistence.md)
- [第 7 章：Leader-Follower 架构](ch07-leader-follower.md)

# 第三部：工具系统

- [第 8 章：两层工具抽象](ch08-tool-abstraction.md)
...
- [第 14 章：增量渲染管线](ch14-render-pipeline.md)
- [第 15 章：流式 Markdown](ch15-streaming-markdown.md)
- [第 16 章：终端工程学](ch16-terminal-craft.md)
